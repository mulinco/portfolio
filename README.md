# 🕸️ Maria Rodrigues | Full Stack Portfolio
...
A troca de tema não altera apenas as cores (`colors`), mas reestrutura a geometria dos componentes e a tipografia em tempo real.
...
- **Interações Ricas:**
  - **Footer Inteligente:** Funcionalidade "Click-to-Copy" com feedback visual.
  - **Cards Interativos:** Efeitos de hover 3D e scale.
...
│   ├── layout/     # Estrutura global (Header, Footer, Nav)
│   ├── ui/         # Componentes reutilizáveis (ScrollProgress, Stickers)
│   ├── hero/       # Seção principal e animações
│   ├── projects/   # Lógica e exibição dos projetos
│   ├── cv/         # Componentes do Currículo
│   └── pets/       # Easter Eggs e elementos lúdicos
├── hooks/          # Hooks customizados (useTypewriter, etc)
├── lib/            # Utilitários e Configuração de Tema
├── pages/          # Estrutura de rotas da aplicação
├── services/       # Integrações externas (API, Email)
└── schemas/        # Validações de formulário e tipagem
```
...
- [ ] Backend Integration: Implementar um CMS Headless para gestão dinâmica dos projetos sem precisar alterar o código.

- [ ] Testes Automatizados: Adicionar cobertura de testes unitários (Jest) e E2E (Cypress).

- [ ] Internacionalização (i18n): Suporte nativo para Inglês/Português.
...
- **Background:** Transição de carreira da Biologia/Genética para a Tecnologia.
