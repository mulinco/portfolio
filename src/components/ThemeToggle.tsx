  ...
  return (
    ...
    >
      <div className="relative w-6 h-6">
        <span
          className={`absolute inset-0 transition-all duration-500 ${theme === "goth" ? "opacity-100 rotate-0" : "opacity-0 -rotate-90"}`}
        >
          <Skull size={24} />
        </span>
        <span
          className={`absolute inset-0 transition-all duration-500 ${theme === "kawaii" ? "opacity-100 rotate-0" : "opacity-0 rotate-90"}`}
        >
