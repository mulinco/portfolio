    ...
    >
      ...
      */}
        ...
        */}
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none kawaii:hidden z-10">
              <img
                src="/ink.png"
                alt=""
                className="absolute inset-0 w-full h-full object-cover opacity-40 mix-blend-overlay filter invert"
              />
            </div>
            ...
            <img
              src="/foto-dark.png"
              alt="Goth Persona"
              className="absolute inset-0 w-full h-full object-cover object-center transition-all duration-500 z-20 mix-blend-luminosity contrast-125 brightness-90 kawaii:hidden"
            />
            <img
              src="/foto-light.png"
              alt="Kawaii Persona"
              className="absolute inset-0 w-full h-full object-cover object-center transition-all duration-500 z-20 hidden kawaii:block scale-90 hover:scale-95 origin-bottom sticker-effect-hero"
            />
          ...
          `}
            >
              <div className="mb-4 text-accent kawaii:text-accent animate-bounce">
                {currentIcon}
              </div>
              <span className="block text-accent kawaii:text-white font-bold mb-4 uppercase tracking-[0.2em] text-sm drop-shadow-sm">
                Secret Unlocked
              </span>
              <p className="font-code text-lg text-white leading-relaxed font-medium tracking-wide drop-shadow-md">
                "{fact}"
              </p>
              <p className="text-xs text-text-muted mt-6 kawaii:text-white/70 font-code uppercase tracking-widest opacity-70">
